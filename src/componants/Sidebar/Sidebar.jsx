    ...
    return (
        <div className='mt-8'>
            ...
            <div className='bg-orange-100 text-white mt-5 flex p-4 justify-between items-center rounded-xl text-xl'>
                <p className='bg-orange-700 rounded-2xl p-2 w-14 h-14 items-center flex justify-center hover:bg-orange-900 cursor-pointer' onClick={() => breakHandle(10)}><span>10</span>s</p>
                <p className='bg-orange-700 rounded-2xl p-2 w-14 h-14 items-center flex justify-center hover:bg-orange-900 cursor-pointer' onClick={() => breakHandle(20)}><span>20</span>s</p>
                <p className='bg-orange-700 rounded-2xl p-2 w-14 h-14 items-center flex justify-center hover:bg-orange-900 cursor-pointer' onClick={() => breakHandle(30)}><span>30</span>s</p>
                <p className='bg-orange-700 rounded-2xl p-2 w-14 h-14 items-center flex justify-center hover:bg-orange-900 cursor-pointer' onClick={() => breakHandle(40)}><span>40</span>s</p>
                <p className='bg-orange-700 rounded-2xl p-2 w-14 h-14 items-center flex justify-center hover:bg-orange-900 cursor-pointer' onClick={() => breakHandle(50)}><span>50</span>s</p>
            </div>
